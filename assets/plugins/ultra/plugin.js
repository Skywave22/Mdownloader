// =============================================================================
//  MDownloader plugin — Ultra Movie Parlour (Hindi Dubbed)
//
//  Ultra is a major official Bollywood/South-dubbed movie network on YouTube.
//  Searches their channels and resolves direct MP4 + HLS download links via the
//  InnerTube API — no ffmpeg, no yt-dlp, instant links.
//
...
var CHANNEL = 'Ultra Movie Parlour';
